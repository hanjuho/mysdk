...
namespace hsdk
{
	namespace framework
	{
		...
		*/
		...
		extern Framework g_Framework;

		// 설명 : framework grobal variable. you can read and write. just do not call update.
		extern Framework_UserTimeStream & g_Framework_TimeStream;

		// 설명 : framework grobal variable.
		extern Framework_Callbacks & g_Framework_Callbacks;

		// 설명 : framework grobal variable. only read, so do not write forced.
		extern const Framework_State & g_Direct3D_State;

		// 설명 : framework grobal variable. only read, so do not write forced.
		extern const Framework_Window & g_Framework_Window;

		// 설명 : framework grobal variable. only read, so do not write forced.
		extern const Framework_Device & g_Framework_Device;
